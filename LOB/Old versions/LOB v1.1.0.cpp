...
int main()
{
	...
	if (corenum < 8)						//Check CPU
	{
		cout << "Your CPU thread-number is " << corenum << " .\nPlease use a bigger or equal to 16-thread CPU.\n";
		system("pause");
		exit(1);
	}
	else
...
void game()								//Main game
{
	long int player_HP, coordinate[2], monster_coordinatex[4], monster_coordinatey[4], monster_type[4], a = 0, level, talent, score, weapon1, weapon2, money, bag[8];		//Varies
	int  r[4];
	...
	while (a == 0)
	{
		...
		else
		{
			...
			else
			{
				...
				if (monster_type[0] == 1)																	//Put Monster
				{
					background[monster_coordinatex[0]][monster_coordinatey[0]] = 'A';
				}
				else
				{
					background[monster_coordinatex[0]][monster_coordinatey[0]] = 'B';
				};

				if (monster_type[1] == 1)																	//Put Monster
				{
					background[monster_coordinatex[1]][monster_coordinatey[1]] = 'A';
				}
				else
				{
					background[monster_coordinatex[1]][monster_coordinatey[1]] = 'B';
				};

				if (monster_type[2] == 1)																	//Put Monster
				{
					background[monster_coordinatex[2]][monster_coordinatey[2]] = 'A';
				}
				else
				{
					background[monster_coordinatex[2]][monster_coordinatey[2]] = 'B';
				};

				if (monster_type[3] == 1)																	//Put Monster
				{
					background[monster_coordinatex[3]][monster_coordinatey[3]] = 'A';
				}
				else
				{
					background[monster_coordinatex[3]][monster_coordinatey[3]] = 'B';
				};
			...
			Move:
				...
				else if ((coordinate[0] == monster_coordinatex[0]) && (coordinate[1] == monster_coordinatey[0]))
				{
					while (a == 0)
					{
						if (player_HP <= 0)
						...
						else
						{
							if (monster_HP[0] > 0)
							{
								...
								else if (monster_type[0] == 2)
								{
									cout << "\n\n\n\nMonster name:Untoileted Bob\n";
								};
								cout << "Monster HP:" << monster_HP[0] << "	Your HP:" << player_HP << "\nChoose your skill\n[1]Normal Attack		[2]Skip Attack\n[3]Restore HP		[S]Save Game\n";
							ChooseSkill1:
								choice = _getch();
								if (choice == '1')
								{
									dam = NA(attack);
									monster_HP[0] = monster_HP[0] - dam;
									score = score + dam;
							...
							else if (monster_HP[0] <= 0)
							{
								...
								monster_coordinatex[0] = 0;
								monster_coordinatey[0] = 0;
								system("Pause");
								break;
							};
				...
				else if ((coordinate[0] == monster_coordinatex[1]) && (coordinate[1] == monster_coordinatey[1]))
				{
					while (a == 0)
					{
						if (player_HP <= 0)
						...
						else
						{
							if (monster_HP[1] > 0)
							{
								...
								else if (monster_type[1] == 2)
								{
									cout << "\n\n\n\nMonster name:Untoileted Bob\n";
								};
								cout << "Monster HP:" << monster_HP[1] << "	Your HP:" << player_HP << "\nChoose your skill\n[1]Normal Attack		[2]Skip Attack\n[3]Restore HP		[S]Save Game\n";
							ChooseSkill2:
								choice = _getch();
								if (choice == '1')
								{
									dam = NA(attack);
									monster_HP[1] = monster_HP[1] - dam;
									score = score + dam;
									cout << "Monster HP decreases " << dam << " .\n";
								}
								else if (choice == '2')
							...
							else if (monster_HP[1] <= 0)
							{
								...
								monster_coordinatex[1] = 0;
								monster_coordinatey[1] = 0;
								system("Pause");
								break;
							}
							player_HP = player_HP - 20;
				...
				else if ((coordinate[0] == monster_coordinatex[2]) && (coordinate[1] == monster_coordinatey[2]))
				{
					while (a == 0)
					{
						if (player_HP <= 0)
						...
						else
						{
							if (monster_HP[2] > 0)
							{
								...
								else if (monster_type[2] == 2)
								{
									cout << "\n\n\n\nMonster name:Untoileted Bob\n";
								};
								cout << "Monster HP:" << monster_HP[2] << "	Your HP:" << player_HP << "\nChoose your skill\n[1]Normal Attack		[2]Skip Attack\n[3]Restore HP		[S]Save Game\n";
							ChooseSkill3:
								choice = _getch();
								if (choice == '1')
								{
									dam = NA(attack);
									monster_HP[2] = monster_HP[2] - dam;
									score = score + dam;
									cout << "Monster HP decreases " << dam << " .\n";
								}
								else if (choice == '2')
							...
							else if (monster_HP[2] <= 0)
							{
								...
								monster_coordinatex[2] = 0;
								monster_coordinatey[2] = 0;
								system("Pause");
								break;
							}
							player_HP = player_HP - 20;
				...
				else if ((coordinate[0] == monster_coordinatex[3]) && (coordinate[1] == monster_coordinatey[3]))
				{
					while (a == 0)
					{
						if (player_HP <= 0)
						...
						else
						{
							if (monster_HP[3] > 0)
							{
								...
								else if (monster_type[3] == 2)
								{
									cout << "\n\n\n\nMonster name:Untoileted Bob\n";
								};
								cout << "Monster HP:" << monster_HP[3] << "	Your HP:" << player_HP << "\nChoose your skill\n[1]Normal Attack		[2]Skip Attack\n[3]Restore HP		[S]Save Game\n";
							ChooseSkill4:
								choice = _getch();
								if (choice == '1')
								{
									dam = NA(attack);
									monster_HP[3] = monster_HP[3] - dam;
									score = score + dam;
									cout << "Monster HP decreases " << dam << " .\n";
								}
								else if (choice == '2')
							...
							else if (monster_HP[3] <= 0)
							{
								...
								monster_coordinatex[3] = 0;
								monster_coordinatey[3] = 0;
								system("Pause");
								break;
							}
							player_HP = player_HP - 20;
